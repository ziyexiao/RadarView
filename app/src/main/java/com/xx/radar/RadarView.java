...
public class RadarView extends View {
    ...
    //数据的数值，控制覆盖面积
    private float[] data = new float[]{18.3f, 42.8f, 48.3f, 25.6f, 38.7f};
    //数据的属性
    private String[] dataDesc = new String[]{"生存评分", "Rating评分", "战斗评分", "支援评分", "吃鸡率评分"};
    //最大值
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        radarTextMargin = typedArray.getColor(R.styleable.RadarView_radarTextMargin, PixeUtils.dip2px(context,5));
        radarValueSize = typedArray.getDimension(R.styleable.RadarView_radarValueSize, PixeUtils.sp2px(context,15));
        radarDescSize = typedArray.getDimension(R.styleable.RadarView_radarDescSize, PixeUtils.sp2px(context,8));
        typedArray.recycle();
    }
